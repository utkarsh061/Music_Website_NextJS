        ...
        <div className="py-12 bg-gray-900">
            <div>
                <div className="text-center">
                    ...
                    <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-white sm:text-4xl">Learn From Utkarsh</p>
                </div>
            </div>
            <div className="mt-10">
                        ...
                        <div key={item.id} className="flex justify-center">
                            ...
                            >
                                <div className="p-4 sm:p-6 flex flex-col items-center text-center flex-grow">
                                    ...
                                    <p className="text-sm text-neutral-600 dark:text-neutral-400 flex-grow mb-5">{item.description}</p>
